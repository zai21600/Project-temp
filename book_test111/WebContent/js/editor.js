document.createElement('color_red');
document.createElement('color_blue');
document.createElement('color_green');
document.createElement('color_black');
document.createElement('size_5');
document.createElement('size_10');
document.createElement('size_20');
document.createElement('size_30');
...
$("#newbook").on("click", function() {
	if($("#newbookname").val() != "") {
		...
		alert("The input book name is empty")
	}
})
